...
echo "  1. Open QQ and let the user scan the QQ login QR once."
echo "  2. Open QQ Classic Farm once, wait for the miniapp cache, close it, then open it again."
echo "  3. Watch: journalctl -u qq-farm-code-capture -f"
